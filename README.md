...
```python
from integra.sei import DocumentosArvore, TipoDocumento
...
| `integra.sei.assinar_documento` | Assinatura eletrônica (senha do próprio servidor) | ✅ |
| `integra.sei.documentos_arvore` | Consulta/seleção de documentos na árvore | ✅ |
